...
$Controls = @{
    ...
    TextBox1 = [Windows.Forms.TextBox]@{ Name = "TextBox1"; Location = [Drawing.Point]::new($Column[2], $Row[1]); Size = [Drawing.Size]::new(300, 20) }
    TextBox2 = [Windows.Forms.TextBox]@{ Name = "TextBox2"; Location = [Drawing.Point]::new($Column[2], $Row[2]); Size = [Drawing.Size]::new(300, 20) }
    TextBox3 = [Windows.Forms.TextBox]@{ Name = "TextBox3"; Location = [Drawing.Point]::new($Column[2], $Row[3]); Size = [Drawing.Size]::new(300, 20) }
